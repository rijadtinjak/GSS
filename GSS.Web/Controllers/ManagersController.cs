...
namespace GSS.Web.Controllers
{
    ...
    public class ManagersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,UserId")] Manager manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,UserId,Active")] Manager manager)
        {
            if (id != manager.Id)
            {
                return NotFound();
